...
step 11: Now to install pytorch : 
...
step 12: Now to install nltk execute :
...
step 13: Unzip the proejct folder in C drive 

step 14: Open Anaconda promt and activte mynev then navigate to proejct Folder.

step 15: Now exectue "Code ." in Anaconda promt it will open Visual studio Code in that folder.

step 16: Now select (python conda:myenv) to run code train.py 
